 ...
 */
int cerebro_clusterlist_genders_init(genders_t *handle, char *file, char *clusterlist_module_name);
 ...
 */
int cerebro_clusterlist_genders_finish(genders_t *handle, char **file, char *clusterlist_module_name);
 ...
 */
int cerebro_clusterlist_genders_get_all_nodes(genders_t handle, char **nodes, unsigned int nodeslen, char *clusterlist_module_name);
 ...
 */
int cerebro_clusterlist_genders_numnodes(genders_t handle, char *clusterlist_module_name);
