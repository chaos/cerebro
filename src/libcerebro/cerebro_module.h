 ...
 */
int cerebro_clusterlist_module_get_all_nodes(char **nodes, unsigned int nodeslen);
 ...
 */
int cerebro_clusterlist_module_get_nodename(const char *node, char *buf, unsigned int buflen);
